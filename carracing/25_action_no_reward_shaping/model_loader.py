...
class MLP_Policy(nn.Module):
    def __init__(self, state_vector_len=60, output_vector_len=25):
...
class CNN_Policy(nn.Module):
    def __init__(self, input_shape, output_vector_len=25):
...
def get_policy(device, policy_type, weights_path='', state_vector_len=60, input_shape=(4,80,80),output_vector_len=25):
